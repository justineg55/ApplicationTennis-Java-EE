...
<body>
	...
	<div class="container">
		...
		<div
			...
			<a href="/Appljoueur/ajoutermatch">
		...
		<table class="table">
			...
			il n'y a aucune occurence trouvée
				...
				<tr>
							<th><c:out value="${match.id}"></c:out></th>
							<td><c:out value="${match.nomTournoi}"></c:out></td>
							<td><c:out value="${match.annee}"></c:out></td>
							<td><c:out value="${match.type}"></c:out></td>
							<td><c:out value="${match.finaliste}"></c:out></td>
							<td><c:out value="${match.vainqueur}"></c:out></td>
