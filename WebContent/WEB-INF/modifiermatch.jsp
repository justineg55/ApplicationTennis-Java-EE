...
<form class="needs-validation "  novalidate action="modifiermatch" method=post>
  <div class="form-row">
    <div class="col-md-3 mb-3">
      ...
      <option selected disabled value="">Sélectionner...</option>
      	<c:forEach var="tournoi" items="${tournois}">
        	<option value="${tournoi.id}" <c:if test="${tournoi.id == tournoiIdSelected}" >selected</c:if>>${tournoi.nom}</option>
		</c:forEach>
      </select>
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input name= "annee" type="number" max="2020" class="form-control" style="width:400px;" id="validationCustom02" value='${epreuve.annee}'  required>
		  <div class="valid-feedback">
        Très bien!
      </div>
      <div class="invalid-feedback">
  ...
  <div class="form-row">
    <div class="col-md-3 mb-3">
      ...
      <select name="type" class="custom-select" id="validationCustom03" style="width:400px;" required>
        ...
        <option value="F" <c:if test="${epreuve.type == 'F'}" >selected</c:if>>Femme</option>
		<option value="H"<c:if test="${epreuve.type == 'H'}" >selected</c:if>>Homme</option>
      </select>
	   <div class="valid-feedback">
       Très bien!
     </div>
    ...
    <div class="col-md-3 mb-3">
      ...
      <option selected disabled value="">Sélectioner...</option>
      	<c:forEach var="joueur" items="${joueurs}">
        	<option value="${joueur.id}" <c:if test="${joueur.id == finalisteIdSelected}" >selected</c:if>>${joueur.nom}</option>
		</c:forEach>
      </select>
	   <div class="valid-feedback">
       Très bien!
    ...
    <div class="col-md-3 mb-3">
      ...
      <option selected disabled value="">Sélectioner...</option>
      	<c:forEach var="joueur" items="${joueurs}">
        	...
        	<option value="${joueur.id}" <c:if test="${joueur.id == vainqueurIdSelected}" >selected</c:if> >${joueur.nom}</option>
		</c:forEach>
      </select>
	   <div class="valid-feedback">
       Très bien!
    ...
    <div class="col-md-3 mb-3">
      <label for="set1vainqueur" style="width:max-content;" >Set 1 : Nombre de jeux gagnés par le vainqueur :</label>
		<input type="number" name="set1vainqueur" min="0" max="7" class="form-control" style="width:400px;" id="validationCustom06" value="${nbjeuxSet1Vainqueur}"  required>
	   <div class="valid-feedback">
       Très bien!
     </div>
      <div class="invalid-feedback">
    ...
    <div class="col-md-3 mb-3">
      <label for="set1finaliste" style="width:max-content;" >Set 1 : Nombre de jeux gagnés par le finaliste :</label>
		<input type="number" name="set1finaliste" min="0" max="7" class="form-control" style="width:400px;" id="validationCustom07" value="${nbjeuxSet1Finaliste}" required>
	   <div class="valid-feedback">
       Très bien!
     </div>
      <div class="invalid-feedback">
    ...
    <div class="col-md-3 mb-3">
      <label for="set2vainqueur" style="width:max-content;" >Set 2 : Nombre de jeux gagnés par le vainqueur :</label>
		<input type="number" name="set2vainqueur" min="0" max="7" class="form-control" style="width:400px;" id="validationCustom08" value="${nbjeuxSet2Vainqueur}" required>
	   <div class="valid-feedback">
       Très bien!
     </div>
      <div class="invalid-feedback">
    ...
    <div class="col-md-3 mb-3">
      <label for="set2finaliste" style="width:max-content;" >Set 2 : Nombre de jeux gagnés par le finaliste :</label>
		<input type="number" name="set2finaliste" min="0" max="7" class="form-control" style="width:400px;" id="validationCustom09" value="${nbjeuxSet2Finaliste}" required>
	   <div class="valid-feedback">
       Très bien!
     </div>
      <div class="invalid-feedback">
    ...
    <div class="col-md-3 mb-3">
      <label for="set3vainqueur" style="width:max-content;" >Set 3 : Nombre de jeux gagnés par le vainqueur :</label>
		<input type="number" name="set3vainqueur" min="0" max="7" class="form-control" style="width:400px;" id="validationCustom10" value="${nbjeuxSet3Vainqueur}" >
	   <div class="valid-feedback">
       Très bien!
     </div>
      <div class="invalid-feedback">
    ...
    <div class="col-md-3 mb-3">
      <label for="set3finaliste" style="width:max-content;" >Set 3 : Nombre de jeux gagnés par le finaliste :</label>
		<input type="number" name="set3finaliste" min="0" max="7" class="form-control" style="width:400px;" id="validationCustom11"  value="${nbjeuxSet3Finaliste}">
	   <div class="valid-feedback">
       Très bien!
     </div>
      <div class="invalid-feedback">
    ...
    <div class="col-md-3 mb-3">
      <label for="set4vainqueur" style="width:max-content;" >Set 4 : Nombre de jeux gagnés par le vainqueur :</label>
		<input type="number" name="set4vainqueur" min="0" max="7" class="form-control" style="width:400px;" id="validationCustom12" value="${nbjeuxSet4Vainqueur}">
	   <div class="valid-feedback">
       Très bien!
     </div>
      <div class="invalid-feedback">
    ...
    <div class="col-md-3 mb-3">
      <label for="set4finaliste" style="width:max-content;" >Set 4 : Nombre de jeux gagnés par le finaliste :</label>
		<input type="number" name="set4finaliste" min="0" max="7" class="form-control" style="width:400px;" id="validationCustom13" value="${nbjeuxSet4Finaliste}">
	   <div class="valid-feedback">
       Très bien!
     </div>
      <div class="invalid-feedback">
    ...
    <div class="col-md-3 mb-3">
      <label for="set5vainqueur" style="width:max-content;" >Set 5 : Nombre de jeux gagnés par le vainqueur :</label>
		<input type="number" name="set5vainqueur" min="0" max="7" class="form-control" style="width:400px;" id="validationCustom14" value="${nbjeuxSet5Vainqueur}">
	   <div class="valid-feedback">
       Très bien!
     </div>
      <div class="invalid-feedback">
    ...
    <div class="col-md-3 mb-3">
      <label for="set5finaliste" style="width:max-content;" >Set 5 : Nombre de jeux gagnés par le finaliste :</label>
		<input type="number" name="set5finaliste" min="0" max="7" class="form-control" style="width:400px;" id="validationCustom15" value="${nbjeuxSet5Finaliste}">
	   <div class="valid-feedback">
       Très bien!
     </div>
      <div class="invalid-feedback">
